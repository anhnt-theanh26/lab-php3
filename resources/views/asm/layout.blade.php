...
<body>
    <div class="wrapper">
        <header class="bg-danger-subtle fixed-top">
            <div class="container">
                <nav class="navbar">
                    <div class="container">
        ...
        <footer class="bg-danger-subtle p-4 footer">
            <div class="container">
                <div class="row">
                        ...
                        <div class="box">
                            <nav class="navbar">
                                ...
                                <div class="">
                                    ...
                                    <p class="text-black">Đóng cửa: 22:00 PM</p>
                    ...
                    <div class="col-md-4 col-6">
                        <div class="box">
                            <div class="">
                                <h1 class="fs-3 text-black">Liên hệ</h1>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="box">
                            <div class="text-black">
                                ...
                                <p class="text-black">Địa chỉ: Ngã 4 , đội 3, thôn Sơn Đồng, xã Tiên Phương, huyện
                                    Chương
                                    Mỹ, thành phố Hà Nội</p>
                                <p class="text-black">Sđt: 0348022004</p>
                                <p class="text-black">Email: nguyentheanh260204@gmail.com</p>
                            </div>
                        </div>
